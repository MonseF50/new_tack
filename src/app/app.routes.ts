...
export const routes: Routes = [
    ...
    { path: 'about', loadComponent: () => import('./components/gallery/gallery.component').then(c => c.GalleryComponent), title: 'gallery' },
    { path: 'about', loadComponent: () => import('./components/contact/contact.component').then(c => c.ContactComponent), title: 'contact' },
